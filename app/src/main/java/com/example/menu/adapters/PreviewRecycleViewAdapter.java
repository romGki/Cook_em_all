...
public class PreviewRecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.ViewHolder>
{
    ...
    public PreviewRecycleViewAdapter(Context context, ArrayList<RecipeModel> recipesModels, RecipeInterface recipeInterface)
    {
